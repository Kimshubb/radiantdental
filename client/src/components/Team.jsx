      ...
      <div class="container px-6 py-12 mx-auto">
        ...
        <div class="grid gap-8 mt-12  md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
          <div class="w-full max-w-xs text-center">
            ...
            <div class="mt-2">
              <h3 class="text-md font-bold text-gray-700">Dr Lelei </h3>
              <span class="mt-1 font-medium text-gray-600 ">Senior Dentist</span>
            </div>
          </div>
          ...
          <div class="w-full max-w-xs text-center">
            ...
            <div class="mt-2">
              <h3 class="text-md font-bold text-gray-700 ">Lucy</h3>
              <span class="mt-1 font-medium text-gray-600 ">Dental Assistant</span>
            </div>
          </div>
          ...
          <div class="w-full max-w-xs text-center">
            ...
            <div class="mt-2">
              <h3 class="text-md font-bold text-gray-700 ">Dr Magara</h3>
          ...
          <div class="w-full max-w-xs text-center">
            ...
            <div class="mt-2">
              <h3 class="text-md font-bold text-gray-700 ">Ashley Kudze</h3>
